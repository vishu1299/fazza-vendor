...
export default function ShippedOrders() {
  ...
  const filteredOrders = shippedOrdersData.filter((order) => {
    const matchesSearch =
      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            <span>Orders</span>
            <span>/</span>
            <span className="text-gray-900 font-medium">Shipped</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Shipped</h1>
