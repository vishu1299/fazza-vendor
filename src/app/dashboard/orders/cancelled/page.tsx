...
const cancelledOrdersData: Order[] = [
  {
    id: "#12481",
    date: "05 Aug 2025",
...
export default function CancelledOrders() {
  ...
  const filteredOrders = cancelledOrdersData.filter((order) => {
    const matchesSearch =
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-gradient-to-br from-red-400 to-pink-400 rounded-full flex items-center justify-center text-white text-sm font-medium">
                            {order.customer
                              .split(" ")
                              .map((n) => n[0])
                              .join("")}
