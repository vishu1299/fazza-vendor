...
const deliveredOrdersData: Order[] = [
  {
    id: "#12471",
    date: "05 Aug 2025",
...
export default function DeliveredOrders() {
  ...
  const filteredOrders = deliveredOrdersData.filter((order) => {
    const matchesSearch =
      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            <span>Orders</span>
            <span>/</span>
            <span className="text-gray-900 font-medium">Delivered</span>
          </div>
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-gradient-to-br from-green-400 to-emerald-400 rounded-full flex items-center justify-center text-white text-sm font-medium">
                            {order.customer
                              .split(" ")
                              .map((n) => n[0])
                              .join("")}
